...
function Ammunation:init()
	...
	self.panel = Panel()
	self.panel:setBounds((screenX - 250) /2, (screenY - 300) /2, 250, 300)
...
function Ammunation:mouseReleased(e)
	if ( e.source.itemName ) then
		...
		elseif (e.source.itemName == "Pistols" or e.source.itemName == "Micro SMGs" or e.source.itemName == "Shotguns" or e.source.itemName == "Assault" or e.source.itemName == "Riffles" or e.source.itemName == "Equipamentos") then
			self.panelClass = Panel()
			self.panelClass:setBounds(75, 200, 250, 300)
